...
function App() {
  ...
  return (
    ...
    to-gray-500 flex items-center justify-center p-4">
      <div className = "bg-white rounded-2xl shadow0x1 w-full max-w-lg p-8">
                  ...
                  {editingTodo === todo._id ? (
                    <div className="flex items-center gap-x-3">
                      ...
                      <button className="px-4 py-2 bg-gray-200
                        ...
                        cursor-pointer" onClick = {() => setEditingTodo(null)}>
                        <IoClose/>
                      </button>
                      </div>
                    </div>
                    ...
                    <div>
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex gap-x-2">
                          ...
                          hover:bg-blue-50 duration-200" onClick = {() => startEditing(todo)}>
                          <MdModeEditOutline/>
                        </button>
                        <button onClick = {() => {
                          deleteTodo(todo._id)
